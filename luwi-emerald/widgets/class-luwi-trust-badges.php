...
class Luwi_Widget_Trust_Badges extends Luwi_Widget_Base {
	...
	public function get_title() {
		return __( 'Luwi Trust Badges', 'luwi-emerald' );
	}
	...
	protected function register_controls() {
		...
		$repeater->add_control(
			'badge_title',
			array(
				'label'   => __( 'Title', 'luwi-emerald' ),
				'type'    => \Elementor\Controls_Manager::TEXT,
				'default' => __( 'Free Shipping', 'luwi-emerald' ),
			)
		);
		...
		$repeater->add_control(
			'badge_description',
			array(
				'label'   => __( 'Description', 'luwi-emerald' ),
				'type'    => \Elementor\Controls_Manager::TEXT,
				'default' => __( 'On orders over $100', 'luwi-emerald' ),
			)
		);
		...
		$this->add_control(
			'badges',
			array(
				'label'   => __( 'Trust Badges', 'luwi-emerald' ),
				'type'    => \Elementor\Controls_Manager::REPEATER,
				'fields'  => $repeater->get_controls(),
				'default' => array(
					array(
						'badge_title'       => __( 'Free Shipping', 'luwi-emerald' ),
						'badge_description' => __( 'On orders over $100', 'luwi-emerald' ),
						'badge_icon'        => array( 'value' => 'fas fa-shipping-fast', 'library' => 'fa-solid' ),
					),
					array(
						'badge_title'       => __( '15-Day Returns', 'luwi-emerald' ),
						'badge_description' => __( 'Money-back guarantee', 'luwi-emerald' ),
						'badge_icon'        => array( 'value' => 'fas fa-undo', 'library' => 'fa-solid' ),
					),
					array(
						'badge_title'       => __( 'Secure Payment', 'luwi-emerald' ),
						'badge_description' => __( '256-bit SSL encryption', 'luwi-emerald' ),
						'badge_icon'        => array( 'value' => 'fas fa-lock', 'library' => 'fa-solid' ),
					),
					array(
						'badge_title'       => __( 'Expert Support', 'luwi-emerald' ),
						'badge_description' => __( 'Instrument specialists', 'luwi-emerald' ),
		...
		$this->add_control(
			'layout',
			array(
				'label'   => __( 'Layout', 'luwi-emerald' ),
				'type'    => \Elementor\Controls_Manager::SELECT,
				'default' => 'row',
				'options' => array(
					'row'  => __( 'Horizontal Row', 'luwi-emerald' ),
					'grid' => __( 'Grid (2x2)', 'luwi-emerald' ),
				),
			)
		);
		...
		$this->add_control(
			'icon_color',
			array(
				'label'     => __( 'Icon Color', 'luwi-emerald' ),
		...
		$this->add_control(
			'show_dividers',
			array(
				'label'        => __( 'Show Dividers', 'luwi-emerald' ),
