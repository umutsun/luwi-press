...
<main id="content" class="site-main" role="main">
	<div class="luwi-404">
		...
		<div class="luwi-404__hero">
			<span class="luwi-section-label"><?php esc_html_e( 'Lost in the Atelier', 'luwi-emerald' ); ?></span>
			<h1 class="luwi-404__number">404</h1>
			<h2 class="luwi-404__title"><?php esc_html_e( 'This page could not be found', 'luwi-emerald' ); ?></h2>
			<p class="luwi-404__text"><?php esc_html_e( 'The page you are looking for might have been removed, renamed, or is temporarily unavailable.', 'luwi-emerald' ); ?></p>
		</div>
		...
		if ( function_exists( 'wc_get_products' ) ) :
			...
			if ( ! empty( $popular ) ) :
				...
				<div class="luwi-404__products">
					<h3 class="luwi-404__products-title"><?php esc_html_e( 'Popular Right Now', 'luwi-emerald' ); ?></h3>
