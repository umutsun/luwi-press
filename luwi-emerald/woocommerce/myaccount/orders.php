					...
					<div class="luwi-orders__id">
						<strong>
							...
							printf(
								...
								esc_html__( 'Order #%s', 'luwi-emerald' ),
				...
				<div class="luwi-orders__meta">
					<span class="luwi-orders__count">
						...
						printf(
							...
							esc_html( _n( '%d item', '%d items', $item_count, 'luwi-emerald' ) ),
							absint( $item_count )
						);
						?>
					</span>
...
<?php else : ?>
	...
	<div class="luwi-empty-state">
		...
		<h2 class="luwi-empty-state__title"><?php esc_html_e( 'No orders yet', 'luwi-emerald' ); ?></h2>
		<p class="luwi-empty-state__text"><?php esc_html_e( 'Browse our collection and place your first order.', 'luwi-emerald' ); ?></p>
		<a class="luwi-btn luwi-btn--primary" href="<?php echo esc_url( apply_filters( 'woocommerce_return_to_shop_redirect', wc_get_page_permalink( 'shop' ) ) ); ?>">
			<?php esc_html_e( 'Start Shopping', 'luwi-emerald' ); ?>
		</a>
	</div>
