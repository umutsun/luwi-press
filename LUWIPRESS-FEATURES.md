...
- **AI-agent ready** — full REST + WebMCP (161 tools incl. 6 new theme_tool_*) + WordPress 6.9 Abilities API mirror; works with Claude, ChatGPT, the upcoming WP 7.0 native AI client, and the WooCommerce MCP adapter
