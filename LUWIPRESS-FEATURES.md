...
**Version:** 3.1.59 · **License:** GPLv2+ · **Target:** WooCommerce stores
...
**WebMCP companion (1.0.12):** 6 new tools — `theme_tools_list`, `theme_tool_run`, `theme_tool_restore`, `theme_tool_backups`, `theme_settings_get`, `theme_settings_set`. AI agents can drive every audit + repair flow remotely.
...
| **Core bundle size** | ~599 KB ZIP (65 files) — WebMCP companion ~64 KB · Marketplace Sync companion ~29 KB · Open Claw companion ~12 KB |
...
- **AI-agent ready** — full REST + WebMCP (182 tools incl. the new slug-resolver and translation-sync suites) + WordPress 6.9 Abilities API mirror; works with Claude, ChatGPT, the upcoming WP 7.0 native AI client, and the WooCommerce MCP adapter
