...
class LuwiPress_Provider_Google implements LuwiPress_AI_Provider {
	...
	public function chat( array $messages, array $options = array() ) {
		if ( ! $this->is_configured() ) {
			return new WP_Error( 'luwipress_no_api_key', __( 'Google AI API key is not configured.', 'luwipress' ) );
		}
	...
	public function get_default_model() {
		return get_option( 'luwipress_google_model', 'gemini-2.0-flash' );
	}
