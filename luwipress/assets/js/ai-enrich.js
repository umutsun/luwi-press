(function ($) {
  ...
  $btn.on('click', function () {
    ...
    var options = {
      generate_description: $('input[name="luwipress_gen_desc"]').is(':checked'),
      generate_meta_title: $('input[name="luwipress_gen_meta"]').is(':checked'),
      generate_meta_description: $('input[name="luwipress_gen_meta"]').is(':checked'),
      generate_faq: $('input[name="luwipress_gen_faq"]').is(':checked'),
      generate_schema: $('input[name="luwipress_gen_schema"]').is(':checked'),
      generate_alt_text: $('input[name="luwipress_gen_alt"]').is(':checked'),
    };
