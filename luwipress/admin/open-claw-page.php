	...
	<div class="claw-layout">
		...
		<div class="claw-sidebar">
			...
			<div class="claw-sidebar-section">
				...
				<?php
				$tg_token    = get_option( 'luwipress_telegram_bot_token', '' );
				$tg_admins   = get_option( 'luwipress_telegram_admin_ids', '' );
				$wa_number   = get_option( 'luwipress_whatsapp_number', '' );
				$wa_admins   = get_option( 'luwipress_whatsapp_admin_ids', '' );
				?>
				...
				<a href="<?php echo esc_url( admin_url( 'admin.php?page=luwipress-settings&tab=open-claw' ) ); ?>" class="claw-configure-link">
