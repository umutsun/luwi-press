...
class Luwi_Widget_Trust_Badges extends Luwi_Widget_Base {
	...
	public function get_title() {
		return __( 'Luwi Trust Badges', 'luwi-gold' );
	}
	...
	protected function register_controls() {
		...
		$repeater->add_control(
			'badge_title',
			array(
				'label'   => __( 'Title', 'luwi-gold' ),
				'type'    => \Elementor\Controls_Manager::TEXT,
				'default' => __( 'Free Shipping', 'luwi-gold' ),
			)
		);
		...
		$repeater->add_control(
			'badge_description',
			array(
				'label'   => __( 'Description', 'luwi-gold' ),
				'type'    => \Elementor\Controls_Manager::TEXT,
				'default' => __( 'On orders over $100', 'luwi-gold' ),
			)
		);
		...
		$this->add_control(
			'badges',
			array(
				'label'   => __( 'Trust Badges', 'luwi-gold' ),
				'type'    => \Elementor\Controls_Manager::REPEATER,
				'fields'  => $repeater->get_controls(),
				'default' => array(
					array(
						'badge_title'       => __( 'Free Shipping', 'luwi-gold' ),
						'badge_description' => __( 'On orders over $100', 'luwi-gold' ),
						'badge_icon'        => array( 'value' => 'fas fa-shipping-fast', 'library' => 'fa-solid' ),
					),
					array(
						'badge_title'       => __( '15-Day Returns', 'luwi-gold' ),
						'badge_description' => __( 'Money-back guarantee', 'luwi-gold' ),
						'badge_icon'        => array( 'value' => 'fas fa-undo', 'library' => 'fa-solid' ),
					),
					array(
						'badge_title'       => __( 'Secure Payment', 'luwi-gold' ),
						'badge_description' => __( '256-bit SSL encryption', 'luwi-gold' ),
						'badge_icon'        => array( 'value' => 'fas fa-lock', 'library' => 'fa-solid' ),
					),
					array(
						'badge_title'       => __( 'Expert Support', 'luwi-gold' ),
						'badge_description' => __( 'Instrument specialists', 'luwi-gold' ),
		...
		$this->add_control(
			'layout',
			array(
				'label'   => __( 'Layout', 'luwi-gold' ),
				'type'    => \Elementor\Controls_Manager::SELECT,
				'default' => 'row',
				'options' => array(
					'row'  => __( 'Horizontal Row', 'luwi-gold' ),
					'grid' => __( 'Grid (2x2)', 'luwi-gold' ),
				),
			)
		);
		...
		$this->add_control(
			'show_dividers',
			array(
				'label'        => __( 'Show Dividers', 'luwi-gold' ),
