		...
		<div class="luwi-container luwi-container--wide">
			<div class="site-header__inner">
				...
				<nav id="site-navigation" class="main-navigation" role="navigation"
					aria-label="<?php esc_attr_e( 'Primary Menu', 'luwi-gold' ); ?>">
					<button class="menu-toggle" aria-controls="primary-menu" aria-expanded="false"
						aria-label="<?php esc_attr_e( 'Toggle Menu', 'luwi-gold' ); ?>">
						<span class="menu-toggle__bar"></span>
						<span class="menu-toggle__bar"></span>
						<span class="menu-toggle__bar"></span>
					</button>
					<?php
					// Try primary location first; if not assigned yet, fall back to
					// any registered menu so the nav always renders.
					$nav_args = array(
					...
					if ( ! has_nav_menu( 'primary' ) ) {
						...
						if ( ! empty( $menus ) ) {
							$nav_args['menu']            = $menus[0]->term_id;
							$nav_args['theme_location']  = '';
						}
					}
				...
				<div class="site-header__actions">
					<?php if ( get_theme_mod( 'luwi_show_mode_toggle', true ) ) : ?>
						<button class="luwi-color-mode-toggle" aria-label="<?php esc_attr_e( 'Toggle color mode', 'luwi-gold' ); ?>">
