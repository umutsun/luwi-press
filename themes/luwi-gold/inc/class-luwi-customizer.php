...
class Luwi_Customizer {
	...
	public static function register( $wp_customize ) {
		...
		$wp_customize->add_panel( 'luwi_panel', array(
			'title'    => __( 'Luwi Theme Options', 'luwi-gold' ),
			'priority' => 30,
		) );
		...
		$wp_customize->add_control( 'luwi_color_mode', array(
			'label'   => __( 'Default Color Mode', 'luwi-gold' ),
			'section' => 'luwi_color_mode_section',
			'type'    => 'radio',
			'choices' => array(
				'light' => __( 'Light', 'luwi-gold' ),
				'dark'  => __( 'Dark', 'luwi-gold' ),
				'auto'  => __( 'Auto (System Preference)', 'luwi-gold' ),
			),
		) );
		...
		$wp_customize->add_control( 'luwi_show_mode_toggle', array(
			'label'   => __( 'Show Light/Dark Toggle', 'luwi-gold' ),
			'section' => 'luwi_color_mode_section',
			'type'    => 'checkbox',
		) );
		...
		$wp_customize->add_section( 'luwi_colors_section', array(
			'title' => __( 'Brand Colors', 'luwi-gold' ),
			'panel' => 'luwi_panel',
		) );
		...
		$color_settings = array(
			'luwi_color_primary' => array(
				'default' => '#735c00',
				'label'   => __( 'Primary Color', 'luwi-gold' ),
			),
			'luwi_color_accent' => array(
				'default' => '#545e76',
				'label'   => __( 'Accent Color', 'luwi-gold' ),
			),
			'luwi_color_text' => array(
				'default' => '#1b1c1c',
				'label'   => __( 'Text Color', 'luwi-gold' ),
			),
			'luwi_color_bg' => array(
				'default' => '#fcf9f8',
				'label'   => __( 'Background Color', 'luwi-gold' ),
			),
		);
		...
		$wp_customize->add_control( 'luwi_heading_font', array(
			'label'   => __( 'Heading Font', 'luwi-gold' ),
		...
		$wp_customize->add_control( 'luwi_container_width', array(
			'label'       => __( 'Container Width (px)', 'luwi-gold' ),
		...
		$wp_customize->add_control( 'luwi_sticky_header', array(
			'label'   => __( 'Sticky Header', 'luwi-gold' ),
			'section' => 'luwi_layout_section',
			'type'    => 'checkbox',
		) );
		...
		if ( class_exists( 'WooCommerce' ) ) {
			$wp_customize->add_section( 'luwi_wc_section', array(
				'title' => __( 'WooCommerce Layout', 'luwi-gold' ),
				'panel' => 'luwi_panel',
			) );
			...
			$wp_customize->add_control( 'luwi_shop_columns', array(
				'label'   => __( 'Products Per Row', 'luwi-gold' ),
			...
			$wp_customize->add_control( 'luwi_products_per_page', array(
				'label'       => __( 'Products Per Page', 'luwi-gold' ),
				'section'     => 'luwi_wc_section',
				'type'        => 'number',
		...
		$wp_customize->add_section( 'luwi_a11y_section', array(
			'title' => __( 'Accessibility', 'luwi-gold' ),
			'panel' => 'luwi_panel',
		) );
		...
		$wp_customize->add_control( 'luwi_high_contrast', array(
			'label'       => __( 'High Contrast Mode', 'luwi-gold' ),
			'description' => __( 'Increases color contrast ratios for better readability.', 'luwi-gold' ),
		...
		$wp_customize->add_control( 'luwi_reduce_motion', array(
			'label'       => __( 'Reduce Motion', 'luwi-gold' ),
			'description' => __( 'Disables animations for users sensitive to motion.', 'luwi-gold' ),
			'section'     => 'luwi_a11y_section',
			'type'        => 'checkbox',
		) );
		...
		$wp_customize->add_control( 'luwi_font_size_scale', array(
			'label'       => __( 'Base Font Size (%)', 'luwi-gold' ),
			'description' => __( 'Scale all text up or down. Default: 100%.', 'luwi-gold' ),
			'section'     => 'luwi_a11y_section',
			'type'        => 'range',
