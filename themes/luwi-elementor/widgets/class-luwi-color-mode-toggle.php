...
class Luwi_Widget_Color_Mode_Toggle extends Luwi_Widget_Base {
	...
	public function get_title() {
		return __( 'Luwi Dark Mode Toggle', 'luwi-elementor' );
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			'content_section',
			array(
				'label' => __( 'Toggle', 'luwi-elementor' ),
		...
		$this->add_control(
			...
			array(
				...
				'default' => 'icon',
				'options' => array(
					'icon'   => __( 'Icon Only', 'luwi-elementor' ),
					'pill'   => __( 'Pill Toggle', 'luwi-elementor' ),
					'switch' => __( 'Switch', 'luwi-elementor' ),
				),
			)
		);
	...
	protected function render() {
		...
		<button class="luwi-color-toggle luwi-color-toggle--<?php echo esc_attr( $style ); ?>"
			aria-label="<?php esc_attr_e( 'Toggle color mode', 'luwi-elementor' ); ?>"
