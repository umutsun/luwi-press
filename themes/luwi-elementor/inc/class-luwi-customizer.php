...
class Luwi_Customizer {
	...
	public static function register( $wp_customize ) {
		...
		$wp_customize->add_panel( 'luwi_panel', array(
			'title'    => __( 'Luwi Theme Options', 'luwi-elementor' ),
			'priority' => 30,
		) );
		...
		$wp_customize->add_section( 'luwi_color_mode_section', array(
			'title' => __( 'Color Mode', 'luwi-elementor' ),
			'panel' => 'luwi_panel',
		) );
		...
		$wp_customize->add_control( 'luwi_color_mode', array(
			'label'   => __( 'Default Color Mode', 'luwi-elementor' ),
			'section' => 'luwi_color_mode_section',
			'type'    => 'radio',
			'choices' => array(
				'light' => __( 'Light', 'luwi-elementor' ),
				'dark'  => __( 'Dark', 'luwi-elementor' ),
				'auto'  => __( 'Auto (System Preference)', 'luwi-elementor' ),
			),
		) );
		...
		$wp_customize->add_control( 'luwi_show_mode_toggle', array(
			'label'   => __( 'Show Light/Dark Toggle', 'luwi-elementor' ),
			'section' => 'luwi_color_mode_section',
			'type'    => 'checkbox',
		) );
		...
		$wp_customize->add_section( 'luwi_colors_section', array(
			'title' => __( 'Brand Colors', 'luwi-elementor' ),
			'panel' => 'luwi_panel',
		) );
		...
		$color_settings = array(
			'luwi_color_primary' => array(
				'default' => '#735c00',
				'label'   => __( 'Primary Color', 'luwi-elementor' ),
			),
			'luwi_color_accent' => array(
				'default' => '#545e76',
				'label'   => __( 'Accent Color', 'luwi-elementor' ),
			),
			'luwi_color_text' => array(
				'default' => '#1b1c1c',
				'label'   => __( 'Text Color', 'luwi-elementor' ),
			),
			'luwi_color_bg' => array(
				'default' => '#fcf9f8',
				'label'   => __( 'Background Color', 'luwi-elementor' ),
			),
		);
		...
		$wp_customize->add_section( 'luwi_typography_section', array(
			'title' => __( 'Typography', 'luwi-elementor' ),
			'panel' => 'luwi_panel',
		) );
		...
		$wp_customize->add_control( 'luwi_heading_font', array(
			'label'   => __( 'Heading Font', 'luwi-elementor' ),
		...
		$wp_customize->add_control( 'luwi_body_font', array(
			'label'   => __( 'Body Font', 'luwi-elementor' ),
			'section' => 'luwi_typography_section',
			'type'    => 'select',
			'choices' => array(
				'Inter'     => 'Inter',
		...
		$wp_customize->add_section( 'luwi_layout_section', array(
			'title' => __( 'Layout', 'luwi-elementor' ),
			'panel' => 'luwi_panel',
		) );
		...
		$wp_customize->add_control( 'luwi_container_width', array(
			'label'       => __( 'Container Width (px)', 'luwi-elementor' ),
		...
		$wp_customize->add_control( 'luwi_sticky_header', array(
			'label'   => __( 'Sticky Header', 'luwi-elementor' ),
			'section' => 'luwi_layout_section',
			'type'    => 'checkbox',
		) );
		...
		if ( class_exists( 'WooCommerce' ) ) {
			$wp_customize->add_section( 'luwi_wc_section', array(
				'title' => __( 'WooCommerce Layout', 'luwi-elementor' ),
				'panel' => 'luwi_panel',
			) );
			...
			$wp_customize->add_control( 'luwi_shop_columns', array(
				'label'   => __( 'Products Per Row', 'luwi-elementor' ),
			...
			$wp_customize->add_control( 'luwi_products_per_page', array(
				'label'       => __( 'Products Per Page', 'luwi-elementor' ),
				'section'     => 'luwi_wc_section',
				'type'        => 'number',
		...
		$wp_customize->add_section( 'luwi_a11y_section', array(
			'title' => __( 'Accessibility', 'luwi-elementor' ),
			'panel' => 'luwi_panel',
		) );
		...
		$wp_customize->add_control( 'luwi_high_contrast', array(
			'label'       => __( 'High Contrast Mode', 'luwi-elementor' ),
			'description' => __( 'Increases color contrast ratios for better readability.', 'luwi-elementor' ),
		...
		$wp_customize->add_control( 'luwi_reduce_motion', array(
			'label'       => __( 'Reduce Motion', 'luwi-elementor' ),
			'description' => __( 'Disables animations for users sensitive to motion.', 'luwi-elementor' ),
			'section'     => 'luwi_a11y_section',
			'type'        => 'checkbox',
		) );
		...
		$wp_customize->add_control( 'luwi_font_size_scale', array(
			'label'       => __( 'Base Font Size (%)', 'luwi-elementor' ),
			'description' => __( 'Scale all text up or down. Default: 100%.', 'luwi-elementor' ),
			'section'     => 'luwi_a11y_section',
			'type'        => 'range',
	...
	public static function output_css_variables() {
		...
		$heading   = get_theme_mod( 'luwi_heading_font', 'Playfair Display' );
		$body      = get_theme_mod( 'luwi_body_font', 'Inter' );
