...
<main id="content" class="site-main luwi-container" role="main">
	...
	while ( have_posts() ) :
		...
		the_post_navigation( array(
			'prev_text' => '<span class="screen-reader-text">' . esc_html__( 'Previous Post', 'luwi-elementor' ) . '</span> %title',
			'next_text' => '<span class="screen-reader-text">' . esc_html__( 'Next Post', 'luwi-elementor' ) . '</span> %title',
		) );
