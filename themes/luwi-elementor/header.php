		...
		<div class="luwi-container luwi-container--wide">
			<div class="site-header__inner">
				...
				<nav id="site-navigation" class="main-navigation" role="navigation"
					aria-label="<?php esc_attr_e( 'Primary Menu', 'luwi-elementor' ); ?>">
					<button class="menu-toggle" aria-controls="primary-menu" aria-expanded="false"
						aria-label="<?php esc_attr_e( 'Toggle Menu', 'luwi-elementor' ); ?>">
				...
				<div class="site-header__actions">
					<?php if ( get_theme_mod( 'luwi_show_mode_toggle', true ) ) : ?>
						<button class="luwi-color-mode-toggle" aria-label="<?php esc_attr_e( 'Toggle color mode', 'luwi-elementor' ); ?>">
