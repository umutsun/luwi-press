...
<main id="content" class="site-main luwi-container" role="main">
	<?php if ( have_posts() ) : ?>
		...
		<?php the_posts_pagination( array(
			'prev_text' => '<span class="screen-reader-text">' . esc_html__( 'Previous', 'luwi-emerald' ) . '</span>',
			'next_text' => '<span class="screen-reader-text">' . esc_html__( 'Next', 'luwi-emerald' ) . '</span>',
		) ); ?>
