...
<div class="luwi-shop-page luwi-container">
	...
	<?php if ( apply_filters( 'woocommerce_show_page_title', true ) ) : ?>
		<header class="luwi-shop-header">
			<span class="luwi-section-label"><?php esc_html_e( 'Collection', 'luwi-ruby' ); ?></span>
	...
	<div class="luwi-shop-layout">
		...
		<?php if ( is_active_sidebar( 'shop-sidebar' ) ) : ?>
			<aside class="luwi-shop-sidebar" role="complementary" aria-label="<?php esc_attr_e( 'Shop filters', 'luwi-ruby' ); ?>">
