...
<?php if ( ! WC()->cart->is_empty() ) : ?>
				...
				<li class="woocommerce-mini-cart-item luwi-mini-cart__item <?php echo esc_attr( apply_filters( 'woocommerce_mini_cart_item_class', 'mini_cart_item', $cart_item, $cart_item_key ) ); ?>">
					...
					echo apply_filters(
						...
						sprintf(
							...
							esc_attr( sprintf( __( 'Remove %s from cart', 'luwi-ruby' ), wp_strip_all_tags( $product_name ) ) ),
							esc_attr( $product_id ),
	...
	<div class="luwi-mini-cart__footer">
		<div class="luwi-mini-cart__total">
			<span class="luwi-mini-cart__total-label"><?php esc_html_e( 'Subtotal', 'luwi-ruby' ); ?></span>
...
<?php else : ?>
	...
	<div class="luwi-mini-cart__empty">
		<p class="woocommerce-mini-cart__empty-message"><?php esc_html_e( 'No items yet', 'luwi-ruby' ); ?></p>
	</div>
