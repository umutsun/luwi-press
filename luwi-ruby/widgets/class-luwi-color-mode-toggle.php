...
class Luwi_Widget_Color_Mode_Toggle extends Luwi_Widget_Base {
	...
	public function get_title() {
		return __( 'Luwi Dark Mode Toggle', 'luwi-ruby' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			array(
				...
				'default' => 'icon',
				'options' => array(
					'icon'   => __( 'Icon Only', 'luwi-ruby' ),
					'pill'   => __( 'Pill Toggle', 'luwi-ruby' ),
					'switch' => __( 'Switch', 'luwi-ruby' ),
				),
			)
		);
	...
	protected function render() {
		...
		<button class="luwi-color-toggle luwi-color-toggle--<?php echo esc_attr( $style ); ?>"
			aria-label="<?php esc_attr_e( 'Toggle color mode', 'luwi-ruby' ); ?>"
