...
<div class="luwi-dashboard">
	...
	<div class="luwi-dashboard__welcome">
		...
		<div class="luwi-dashboard__greeting">
			<span class="luwi-section-label"><?php esc_html_e( 'Account', 'luwi-ruby' ); ?></span>
			<h2 class="luwi-dashboard__name">
				<?php
				printf(
					/* translators: %s: customer display name */
					esc_html__( 'Welcome, %s', 'luwi-ruby' ),
	...
	<div class="luwi-dashboard__grid">
		...
		<a href="<?php echo esc_url( wc_get_endpoint_url( 'orders' ) ); ?>" class="luwi-dashboard__card">
			...
			<h3 class="luwi-dashboard__card-title"><?php esc_html_e( 'Orders', 'luwi-ruby' ); ?></h3>
			<p class="luwi-dashboard__card-desc"><?php esc_html_e( 'Track, return, or repurchase', 'luwi-ruby' ); ?></p>
		</a>
		...
		<a href="<?php echo esc_url( wc_get_endpoint_url( 'downloads' ) ); ?>" class="luwi-dashboard__card">
			...
			<h3 class="luwi-dashboard__card-title"><?php esc_html_e( 'Downloads', 'luwi-ruby' ); ?></h3>
			<p class="luwi-dashboard__card-desc"><?php esc_html_e( 'Access your digital files', 'luwi-ruby' ); ?></p>
		</a>
		...
		<a href="<?php echo esc_url( wc_get_endpoint_url( 'edit-address' ) ); ?>" class="luwi-dashboard__card">
			...
			<h3 class="luwi-dashboard__card-title"><?php esc_html_e( 'Addresses', 'luwi-ruby' ); ?></h3>
			<p class="luwi-dashboard__card-desc"><?php esc_html_e( 'Billing & shipping addresses', 'luwi-ruby' ); ?></p>
		</a>
		...
		<a href="<?php echo esc_url( wc_get_endpoint_url( 'edit-account' ) ); ?>" class="luwi-dashboard__card">
			...
			<h3 class="luwi-dashboard__card-title"><?php esc_html_e( 'Account Details', 'luwi-ruby' ); ?></h3>
			<p class="luwi-dashboard__card-desc"><?php esc_html_e( 'Name, email & password', 'luwi-ruby' ); ?></p>
		</a>
	...
	if ( ! empty( $customer_orders ) ) :
		...
		<div class="luwi-dashboard__recent">
			<div class="luwi-dashboard__recent-header">
				<h3 class="luwi-dashboard__recent-title"><?php esc_html_e( 'Recent Orders', 'luwi-ruby' ); ?></h3>
				<a href="<?php echo esc_url( wc_get_endpoint_url( 'orders' ) ); ?>" class="luwi-dashboard__recent-link"><?php esc_html_e( 'View All', 'luwi-ruby' ); ?></a>
			</div>
