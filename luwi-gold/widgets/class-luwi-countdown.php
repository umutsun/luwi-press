...
class Luwi_Widget_Countdown extends Luwi_Widget_Base {
	...
	public function get_title() {
		return __( 'Luwi Countdown', 'luwi-gold' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'target_date',
			array(
				'label'   => __( 'Target Date', 'luwi-gold' ),
		...
		$this->add_control(
			'label_text',
			array(
				'label'   => __( 'Label', 'luwi-gold' ),
				'type'    => \Elementor\Controls_Manager::TEXT,
				'default' => __( 'Sale ends in', 'luwi-gold' ),
			)
		);
		...
		$this->add_control(
			'expired_text',
			array(
				'label'   => __( 'Expired Text', 'luwi-gold' ),
				'type'    => \Elementor\Controls_Manager::TEXT,
				'default' => __( 'This offer has ended', 'luwi-gold' ),
			)
		);
		...
		$this->add_control(
			'number_color',
			array(
				'label'     => __( 'Number Color', 'luwi-gold' ),
		...
		$this->add_control(
			'bg_color',
			array(
				'label'     => __( 'Box Background', 'luwi-gold' ),
				'type'      => \Elementor\Controls_Manager::COLOR,
		...
		<div class="luwi-widget luwi-countdown"
			...
			<div class="luwi-countdown__timer">
				...
				<div class="luwi-countdown__block">
					...
					<span class="luwi-countdown__unit"><?php esc_html_e( 'Days', 'luwi-gold' ); ?></span>
				</div>
				<span class="luwi-countdown__sep">:</span>
				<?php endif; ?>
				<div class="luwi-countdown__block">
					<span class="luwi-countdown__number" data-hours>00</span>
					<span class="luwi-countdown__unit"><?php esc_html_e( 'Hours', 'luwi-gold' ); ?></span>
				</div>
				<span class="luwi-countdown__sep">:</span>
				<div class="luwi-countdown__block">
					<span class="luwi-countdown__number" data-minutes>00</span>
					<span class="luwi-countdown__unit"><?php esc_html_e( 'Min', 'luwi-gold' ); ?></span>
				</div>
				<span class="luwi-countdown__sep">:</span>
				<div class="luwi-countdown__block">
					<span class="luwi-countdown__number" data-seconds>00</span>
					<span class="luwi-countdown__unit"><?php esc_html_e( 'Sec', 'luwi-gold' ); ?></span>
				</div>
			</div>
		</div>
		<?php
