...
<div class="luwi-dashboard">
	...
	<div class="luwi-dashboard__welcome">
		...
		<div class="luwi-dashboard__greeting">
			<span class="luwi-section-label"><?php esc_html_e( 'Account', 'luwi-gold' ); ?></span>
			<h2 class="luwi-dashboard__name">
				<?php
				printf(
					/* translators: %s: customer display name */
					esc_html__( 'Welcome, %s', 'luwi-gold' ),
	...
	<div class="luwi-dashboard__grid">
		...
		<a href="<?php echo esc_url( wc_get_endpoint_url( 'orders' ) ); ?>" class="luwi-dashboard__card">
			...
			<h3 class="luwi-dashboard__card-title"><?php esc_html_e( 'Orders', 'luwi-gold' ); ?></h3>
			<p class="luwi-dashboard__card-desc"><?php esc_html_e( 'Track, return, or repurchase', 'luwi-gold' ); ?></p>
		</a>
		...
		<a href="<?php echo esc_url( wc_get_endpoint_url( 'downloads' ) ); ?>" class="luwi-dashboard__card">
			...
			<h3 class="luwi-dashboard__card-title"><?php esc_html_e( 'Downloads', 'luwi-gold' ); ?></h3>
			<p class="luwi-dashboard__card-desc"><?php esc_html_e( 'Access your digital files', 'luwi-gold' ); ?></p>
		</a>
		...
		<a href="<?php echo esc_url( wc_get_endpoint_url( 'edit-address' ) ); ?>" class="luwi-dashboard__card">
			...
			<h3 class="luwi-dashboard__card-title"><?php esc_html_e( 'Addresses', 'luwi-gold' ); ?></h3>
			<p class="luwi-dashboard__card-desc"><?php esc_html_e( 'Billing & shipping addresses', 'luwi-gold' ); ?></p>
		</a>
		...
		<a href="<?php echo esc_url( wc_get_endpoint_url( 'edit-account' ) ); ?>" class="luwi-dashboard__card">
			...
			<h3 class="luwi-dashboard__card-title"><?php esc_html_e( 'Account Details', 'luwi-gold' ); ?></h3>
			<p class="luwi-dashboard__card-desc"><?php esc_html_e( 'Name, email & password', 'luwi-gold' ); ?></p>
		</a>
	...
	if ( ! empty( $customer_orders ) ) :
		...
		<div class="luwi-dashboard__recent">
			<div class="luwi-dashboard__recent-header">
				<h3 class="luwi-dashboard__recent-title"><?php esc_html_e( 'Recent Orders', 'luwi-gold' ); ?></h3>
				<a href="<?php echo esc_url( wc_get_endpoint_url( 'orders' ) ); ?>" class="luwi-dashboard__recent-link"><?php esc_html_e( 'View All', 'luwi-gold' ); ?></a>
			</div>
