...
if ( ! $checkout->is_registration_enabled() && $checkout->is_registration_required() && ! is_user_logged_in() ) {
	echo esc_html( apply_filters( 'woocommerce_checkout_must_be_logged_in_message', __( 'You must be logged in to checkout.', 'luwi-elementor' ) ) );
	return;
}
?>
...
<form name="checkout" method="post" class="checkout woocommerce-checkout luwi-checkout" action="<?php echo esc_url( wc_get_checkout_url() ); ?>" enctype="multipart/form-data">
	...
	<div class="luwi-checkout__columns">
			...
			<?php if ( $checkout->get_checkout_fields() ) : ?>
				...
				<div id="customer_details" class="luwi-checkout__customer">
					...
					<div class="luwi-checkout__section">
						<h3 class="luwi-checkout__section-title"><?php esc_html_e( 'Billing Details', 'luwi-elementor' ); ?></h3>
						<?php do_action( 'woocommerce_checkout_billing' ); ?>
					</div>

					<div class="luwi-checkout__section">
						<h3 class="luwi-checkout__section-title"><?php esc_html_e( 'Shipping Details', 'luwi-elementor' ); ?></h3>
		...
		<div class="luwi-checkout__sidebar">
			...
			<h3 id="order_review_heading" class="luwi-checkout__section-title"><?php esc_html_e( 'Your Order', 'luwi-elementor' ); ?></h3>
