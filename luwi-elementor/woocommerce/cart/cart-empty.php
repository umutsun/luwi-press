...
if ( wc_get_page_id( 'shop' ) > 0 ) : ?>
	...
	<div class="luwi-empty-state">
		...
		<h2 class="luwi-empty-state__title"><?php esc_html_e( 'Your cart is empty', 'luwi-elementor' ); ?></h2>
		<p class="luwi-empty-state__text"><?php esc_html_e( 'Looks like you haven\'t added any pieces to your collection yet.', 'luwi-elementor' ); ?></p>
		...
		<a class="luwi-btn luwi-btn--primary" href="<?php echo esc_url( apply_filters( 'woocommerce_return_to_shop_redirect', wc_get_page_permalink( 'shop' ) ) ); ?>">
			<?php esc_html_e( 'Explore Collection', 'luwi-elementor' ); ?>
		</a>
	</div>
