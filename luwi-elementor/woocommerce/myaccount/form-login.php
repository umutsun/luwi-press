...
<div class="luwi-auth" id="customer_login">
	...
	<div class="luwi-auth__columns <?php if ( 'yes' !== get_option( 'woocommerce_enable_myaccount_registration' ) ) echo 'luwi-auth__columns--single'; ?>">
		...
		<div class="luwi-auth__card luwi-auth__card--login">
			...
			<h2 class="luwi-auth__title"><?php esc_html_e( 'Sign In', 'luwi-elementor' ); ?></h2>
			...
			<form class="woocommerce-form woocommerce-form-login login" method="post">
				...
				<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
					<label for="username"><?php esc_html_e( 'Email address', 'luwi-elementor' ); ?>&nbsp;<span class="required" aria-hidden="true">*</span><span class="screen-reader-text"><?php esc_html_e( 'Required', 'luwi-elementor' ); ?></span></label>
				...
				<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
					<label for="password"><?php esc_html_e( 'Password', 'luwi-elementor' ); ?>&nbsp;<span class="required" aria-hidden="true">*</span><span class="screen-reader-text"><?php esc_html_e( 'Required', 'luwi-elementor' ); ?></span></label>
				...
				<p class="form-row luwi-auth__row">
					<label class="woocommerce-form__label woocommerce-form__label-for-checkbox woocommerce-form-login__rememberme">
						...
						<span><?php esc_html_e( 'Remember me', 'luwi-elementor' ); ?></span>
					</label>
					<a class="luwi-auth__forgot" href="<?php echo esc_url( wp_lostpassword_url() ); ?>"><?php esc_html_e( 'Forgot password?', 'luwi-elementor' ); ?></a>
				</p>

				<?php wp_nonce_field( 'woocommerce-login', 'woocommerce-login-nonce' ); ?>

				<button type="submit" class="woocommerce-button button woocommerce-form-login__submit luwi-btn luwi-btn--primary luwi-btn--full<?php echo esc_attr( wc_wp_theme_get_element_class_name( 'button' ) ? ' ' . wc_wp_theme_get_element_class_name( 'button' ) : '' ); ?>" name="login" value="<?php esc_attr_e( 'Sign In', 'luwi-elementor' ); ?>"><?php esc_html_e( 'Sign In', 'luwi-elementor' ); ?></button>
		...
		<?php if ( 'yes' === get_option( 'woocommerce_enable_myaccount_registration' ) ) : ?>
			...
			<div class="luwi-auth__card luwi-auth__card--register">
				...
				<h2 class="luwi-auth__title"><?php esc_html_e( 'Create Account', 'luwi-elementor' ); ?></h2>
				...
				<form method="post" class="woocommerce-form woocommerce-form-register register" <?php do_action( 'woocommerce_register_form_tag' ); ?>>
					...
					<?php if ( 'no' === get_option( 'woocommerce_registration_generate_username' ) ) : ?>
						<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
							<label for="reg_username"><?php esc_html_e( 'Username', 'luwi-elementor' ); ?>&nbsp;<span class="required" aria-hidden="true">*</span><span class="screen-reader-text"><?php esc_html_e( 'Required', 'luwi-elementor' ); ?></span></label>
					...
					<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
						<label for="reg_email"><?php esc_html_e( 'Email address', 'luwi-elementor' ); ?>&nbsp;<span class="required" aria-hidden="true">*</span><span class="screen-reader-text"><?php esc_html_e( 'Required', 'luwi-elementor' ); ?></span></label>
					...
					<?php if ( 'no' === get_option( 'woocommerce_registration_generate_password' ) ) : ?>
						<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
							<label for="reg_password"><?php esc_html_e( 'Password', 'luwi-elementor' ); ?>&nbsp;<span class="required" aria-hidden="true">*</span><span class="screen-reader-text"><?php esc_html_e( 'Required', 'luwi-elementor' ); ?></span></label>
							<input type="password" class="woocommerce-Input woocommerce-Input--text input-text" name="password" id="reg_password" autocomplete="new-password" required aria-required="true" />
						</p>
					<?php else : ?>
						<p class="luwi-auth__note"><?php esc_html_e( 'A link to set a new password will be sent to your email address.', 'luwi-elementor' ); ?></p>
					<?php endif; ?>
