					...
					<div class="luwi-orders__id">
						<strong>
							...
							printf(
								...
								esc_html__( 'Order #%s', 'luwi-elementor' ),
				...
				<div class="luwi-orders__meta">
					<span class="luwi-orders__count">
						...
						printf(
							...
							esc_html( _n( '%d item', '%d items', $item_count, 'luwi-elementor' ) ),
							absint( $item_count )
						);
						?>
					</span>
...
<?php else : ?>
	...
	<div class="luwi-empty-state">
		...
		<h2 class="luwi-empty-state__title"><?php esc_html_e( 'No orders yet', 'luwi-elementor' ); ?></h2>
		<p class="luwi-empty-state__text"><?php esc_html_e( 'Browse our collection and place your first order.', 'luwi-elementor' ); ?></p>
		<a class="luwi-btn luwi-btn--primary" href="<?php echo esc_url( apply_filters( 'woocommerce_return_to_shop_redirect', wc_get_page_permalink( 'shop' ) ) ); ?>">
			<?php esc_html_e( 'Start Shopping', 'luwi-elementor' ); ?>
		</a>
	</div>
