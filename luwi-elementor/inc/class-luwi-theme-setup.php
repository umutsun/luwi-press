...
class Luwi_Theme_Setup {
	...
	public static function setup() {
		load_theme_textdomain( 'luwi-elementor', LUWI_THEME_DIR . '/languages' );
		...
		register_nav_menus( array(
			'primary' => esc_html__( 'Primary Menu', 'luwi-elementor' ),
			'footer'  => esc_html__( 'Footer Menu', 'luwi-elementor' ),
			'mobile'  => esc_html__( 'Mobile Menu', 'luwi-elementor' ),
		) );
	...
	public static function register_sidebars() {
		register_sidebar( array(
			'name'          => esc_html__( 'Shop Sidebar', 'luwi-elementor' ),
			'id'            => 'shop-sidebar',
			'description'   => esc_html__( 'Widgets for the shop/product archive pages.', 'luwi-elementor' ),
		...
		register_sidebar( array(
			'name'          => esc_html__( 'Blog Sidebar', 'luwi-elementor' ),
			'id'            => 'blog-sidebar',
			'description'   => esc_html__( 'Widgets for blog pages.', 'luwi-elementor' ),
			'before_widget' => '<div id="%1$s" class="widget luwi-widget %2$s">',
			'after_widget'  => '</div>',
			'before_title'  => '<h3 class="widget-title">',
			'after_title'   => '</h3>',
		...
		register_sidebar( array(
			'name'          => esc_html__( 'Footer Column 1', 'luwi-elementor' ),
			'id'            => 'footer-1',
			'before_widget' => '<div id="%1$s" class="widget luwi-widget %2$s">',
			'after_widget'  => '</div>',
		...
		register_sidebar( array(
			'name'          => esc_html__( 'Footer Column 2', 'luwi-elementor' ),
			'id'            => 'footer-2',
			'before_widget' => '<div id="%1$s" class="widget luwi-widget %2$s">',
			'after_widget'  => '</div>',
			'before_title'  => '<h4 class="widget-title">',
		...
		register_sidebar( array(
			'name'          => esc_html__( 'Footer Column 3', 'luwi-elementor' ),
			'id'            => 'footer-3',
			'before_widget' => '<div id="%1$s" class="widget luwi-widget %2$s">',
			'after_widget'  => '</div>',
			'before_title'  => '<h4 class="widget-title">',
	...
	public static function skip_link() {
		echo '<a class="skip-link screen-reader-text" href="#content">'
			. esc_html__( 'Skip to content', 'luwi-elementor' )
			. '</a>';
	}
