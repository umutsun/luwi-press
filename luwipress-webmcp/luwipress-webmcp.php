 ...
 * Description: Model Context Protocol (MCP) server for LuwiPress — exposes 135+ REST tools to AI agents (Claude Code, OpenAI, custom clients) via Streamable HTTP transport. Requires the core LuwiPress plugin.
 * Version: 1.0.10
...
define( 'LUWIPRESS_WEBMCP_VERSION', '1.0.10' );
