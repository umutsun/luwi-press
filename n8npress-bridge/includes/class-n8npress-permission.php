 ...
 *  2. check_token()        — Bearer token or X-n8nPress-Token header
...
class N8nPress_Permission {
     ...
     *  - X-n8nPress-Token: <token>
     *
     * Token is compared against the stored n8npress_seo_api_token option
