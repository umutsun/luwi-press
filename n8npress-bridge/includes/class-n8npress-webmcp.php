...
class N8nPress_WebMCP {
    ...
    const ENDPOINT_PATH        = '/n8npress/v1/mcp';
    ...
    public function register_mcp_endpoint() {
        ...
        register_rest_route( 'n8npress/v1', '/mcp', array(
            array(
                'methods'             => 'POST',
    ...
    private function validate_origin( $request ) {
        ...
        $extra = get_option( 'n8npress_webmcp_allowed_origins', '' );
        if ( ! empty( $extra ) ) {
    ...
    public function handle_delete( $request ) {
        ...
        if ( $session ) {
            delete_transient( 'n8npress_mcp_session_' . $session );
        }
    ...
    private function handle_notification( $method, $params ) {
        switch ( $method ) {
            case 'notifications/initialized':
                N8nPress_Logger::log( 'WebMCP client initialized', 'info' );
                break;
    ...
    private function handle_initialize( $id, $params, $request ) {
        ...
        set_transient(
            'n8npress_mcp_session_' . $this->session_id,
            array(
                'client'     => $client_info,
        ...
        N8nPress_Logger::log( 'WebMCP session started', 'info', array(
    ...
    private function handle_tools_call( $id, $params ) {
        ...
        try {
            ...
            N8nPress_Logger::log( "WebMCP tool called: {$tool_name}", 'info', array(
                'tool'           => $tool_name,
                'execution_ms'   => $ms,
            ) );
            ...
            N8nPress_Logger::log( "WebMCP tool error: {$tool_name} — {$e->getMessage()}", 'error' );
    ...
    private function handle_resources_read( $id, $params ) {
        ...
        switch ( $uri ) {
            case 'n8npress://site-config':
                ...
                $request = new WP_REST_Request( 'GET', '/n8npress/v1/site-config' );
                $data    = $config->get_site_config( $request );
                break;

            case 'n8npress://health':
                $api  = N8nPress_API::get_instance();
    ...
    private function resolve_resource_template( $uri ) {
        ...
        if ( preg_match( '#^n8npress://seo-meta/(\d+)$#', $uri, $m ) ) {
            ...
            $keys = array(
                ...
                '_n8npress_schema', '_n8npress_faq', '_n8npress_howto',
            );
            $meta = array();
            foreach ( $keys as $key ) {
        ...
        if ( preg_match( '#^n8npress://translation-status/(\d+)$#', $uri, $m ) ) {
            ...
            if ( class_exists( 'N8nPress_Translation' ) ) {
                ...
                $request = new WP_REST_Request( 'GET', '/n8npress/v1/translation/status' );
    ...
    private function register_all_tools() {
         ...
         *
         * @param N8nPress_WebMCP $webmcp  The WebMCP instance.
         */
        do_action( 'n8npress_webmcp_register_tools', $this );
    }
    ...
    private function register_system_tools() {
        ...
        $this->register_tool( 'system_logs', array(
            ...
            $request = new WP_REST_Request( 'GET', '/n8npress/v1/logs' );
    ...
    private function register_content_tools() {
        ...
        $this->register_tool( 'content_stale', array(
            ...
            $request = new WP_REST_Request( 'GET', '/n8npress/v1/content/stale' );
    ...
    private function register_seo_tools() {
        $this->register_tool( 'seo_enrich_product', array(
            ...
            $ai      = N8nPress_AI_Content::get_instance();
            $request = new WP_REST_Request( 'POST', '/n8npress/v1/product/enrich' );
        ...
        $this->register_tool( 'seo_batch_status', array(
            ...
            $ai      = N8nPress_AI_Content::get_instance();
            $request = new WP_REST_Request( 'GET', '/n8npress/v1/product/enrich-batch/status' );
        ...
        $this->register_tool( 'seo_rank_math_meta', array(
            ...
            $api     = N8nPress_API::get_instance();
            $request = new WP_REST_Request( 'GET', '/n8npress/v1/test/rank-math' );
    ...
    private function register_aeo_tools() {
        $this->register_tool( 'aeo_generate_faq', array(
            ...
            return $this->proxy_rest_post( 'N8nPress_AEO', 'trigger_faq_generation', array(
        ...
        $this->register_tool( 'aeo_generate_howto', array(
            ...
            return $this->proxy_rest_post( 'N8nPress_AEO', 'trigger_howto_generation', array(
                'product_id' => intval( $args['product_id'] ),
            ) );
        } );
    ...
    private function register_translation_tools() {
        $this->register_tool( 'translation_missing', array(
            ...
            $trans   = N8nPress_Translation::get_instance();
            $request = new WP_REST_Request( 'GET', '/n8npress/v1/translation/missing' );
        ...
        $this->register_tool( 'translation_missing_all', array(
            ...
            $trans   = N8nPress_Translation::get_instance();
            $request = new WP_REST_Request( 'GET', '/n8npress/v1/translation/missing-all' );
        ...
        $this->register_tool( 'translation_request', array(
            ...
            return $this->proxy_rest_post( 'N8nPress_Translation', 'request_translation', array(
        ...
        $this->register_tool( 'translation_quality_check', array(
            ...
            return $this->proxy_rest_post( 'N8nPress_Translation', 'trigger_quality_check', $args );
        } );
        ...
        $this->register_tool( 'translation_taxonomy', array(
            ...
            return $this->proxy_rest_post( 'N8nPress_Translation', 'request_taxonomy_translation', $args );
        } );
        ...
        $this->register_tool( 'translation_taxonomy_missing', array(
            ...
            $trans   = N8nPress_Translation::get_instance();
            $request = new WP_REST_Request( 'GET', '/n8npress/v1/translation/taxonomy-missing' );
            if ( ! empty( $args['language'] ) ) {
                $request->set_param( 'language', $args['language'] );
            }
    ...
    private function register_crm_tools() {
        ...
        $this->register_tool( 'crm_overview', array(
            ...
            $request = new WP_REST_Request( 'GET', '/n8npress/v1/crm/overview' );
        ...
        $this->register_tool( 'crm_segments', array(
            ...
            $crm     = N8nPress_CRM_Bridge::get_instance();
            $request = new WP_REST_Request( 'GET', '/n8npress/v1/crm/segments' );
        ...
        $this->register_tool( 'crm_segment_customers', array(
            ...
            $crm     = N8nPress_CRM_Bridge::get_instance();
            $request = new WP_REST_Request( 'GET', '/n8npress/v1/crm/segment/' . sanitize_text_field( $args['segment'] ) );
    ...
    private function register_email_tools() {
        $this->register_tool( 'send_email', array(
            ...
            return $this->proxy_rest_post( 'N8nPress_Email_Proxy', 'send_email', $args );
        } );
    }
    ...
    private function register_claw_tools() {
        if ( ! class_exists( 'N8nPress_Open_Claw' ) ) {
            return;
        }
        ...
        $this->register_tool( 'claw_execute', array(
            ...
            return $this->proxy_rest_post( 'N8nPress_Open_Claw', 'handle_execute_action', $args );
        } );
        ...
        $this->register_tool( 'claw_channels', array(
            ...
            $claw    = N8nPress_Open_Claw::get_instance();
            $request = new WP_REST_Request( 'GET', '/n8npress/v1/claw/channels' );
    ...
    private function register_chatwoot_tools() {
        if ( ! class_exists( 'N8nPress_Chatwoot' ) ) {
            return;
        }
        ...
        $this->register_tool( 'chatwoot_customer_lookup', array(
            ...
            $chat    = N8nPress_Chatwoot::get_instance();
            $request = new WP_REST_Request( 'GET', '/n8npress/v1/chatwoot/customer-lookup' );
            if ( ! empty( $args['email'] ) ) {
        ...
        $this->register_tool( 'chatwoot_send_message', array(
            ...
            return $this->proxy_rest_post( 'N8nPress_Chatwoot', 'send_message', $args );
        } );
        ...
        $this->register_tool( 'chatwoot_status', array(
            ...
            $chat    = N8nPress_Chatwoot::get_instance();
            $request = new WP_REST_Request( 'GET', '/n8npress/v1/chatwoot/status' );
    ...
    private function register_workflow_tools() {
        $this->register_tool( 'workflow_report_result', array(
            ...
            return $this->proxy_rest_post( 'N8nPress_API', 'handle_workflow_result', $args );
        } );
        ...
        $this->register_tool( 'content_schedule_list', array(
            ...
            if ( ! class_exists( 'N8nPress_Content_Scheduler' ) ) {
                throw new Exception( 'Content Scheduler not loaded' );
            }
            $sched   = N8nPress_Content_Scheduler::get_instance();
            $request = new WP_REST_Request( 'GET', '/n8npress/v1/schedule/list' );
    ...
    private function register_token_tools() {
        $this->register_tool( 'token_usage_stats', array(
            ...
            $api     = N8nPress_API::get_instance();
            $request = new WP_REST_Request( 'GET', '/n8npress/v1/token-usage' );
        ...
        $this->register_tool( 'token_limit_check', array(
            ...
            $api     = N8nPress_API::get_instance();
            $request = new WP_REST_Request( 'GET', '/n8npress/v1/token-usage/check' );
        ...
        $this->register_tool( 'token_recent_calls', array(
            ...
            $api     = N8nPress_API::get_instance();
            $request = new WP_REST_Request( 'GET', '/n8npress/v1/token-recent' );
    ...
    private function register_review_tools() {
        if ( ! class_exists( 'N8nPress_Review_Analytics' ) ) {
            return;
        }
        ...
        $this->register_tool( 'review_analytics', array(
            ...
            $ra      = N8nPress_Review_Analytics::get_instance();
            $request = new WP_REST_Request( 'GET', '/n8npress/v1/review/analytics' );
        ...
        $this->register_tool( 'review_summary', array(
            ...
            $ra      = N8nPress_Review_Analytics::get_instance();
            $request = new WP_REST_Request( 'GET', '/n8npress/v1/review/summary' );
    ...
    private function register_linker_tools() {
        if ( ! class_exists( 'N8nPress_Internal_Linker' ) ) {
            return;
        }
        ...
        $this->register_tool( 'linker_resolve', array(
            ...
            return $this->proxy_rest_post( 'N8nPress_Internal_Linker', 'handle_resolve_links', array(
                'post_id' => intval( $args['post_id'] ),
            ) );
        } );
        ...
        $this->register_tool( 'linker_unresolved', array(
            ...
            $linker  = N8nPress_Internal_Linker::get_instance();
            $request = new WP_REST_Request( 'GET', '/n8npress/v1/content/unresolved-links' );
    ...
    private function register_knowledge_graph_tools() {
        if ( ! class_exists( 'N8nPress_Knowledge_Graph' ) ) {
            return;
        }
        ...
        $this->register_tool( 'knowledge_graph', array(
            ...
            $kg      = N8nPress_Knowledge_Graph::get_instance();
            $request = new WP_REST_Request( 'GET', '/n8npress/v1/knowledge-graph' );
    ...
    private function update_post_internal( $args ) {
        ...
        update_post_meta( $post_id, '_n8npress_last_updated_via', 'webmcp' );
    ...
    public static function is_enabled() {
        return (bool) get_option( 'n8npress_webmcp_enabled', true );
    }
}
