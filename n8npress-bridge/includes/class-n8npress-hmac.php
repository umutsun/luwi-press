<?php
/**
 * n8nPress HMAC Webhook Verification
 *
...
class N8nPress_HMAC {
     ...
     * @var string
     */
    const SIGNATURE_HEADER = 'X-n8nPress-Signature';
     ...
     * @var string
     */
    const TIMESTAMP_HEADER = 'X-n8nPress-Timestamp';
     ...
     * @var string
     */
    const SECRET_OPTION = 'n8npress_hmac_secret';
