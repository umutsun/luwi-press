<?php
/**
 * Token Usage Tracker for n8nPress
 *
...
class N8nPress_Token_Tracker {
	...
	public static function get_today_cost() {
		$cache = get_transient( 'n8npress_today_token_cost' );
		if ( false !== $cache ) {
		...
		$cost = floatval( $cost );
		set_transient( 'n8npress_today_token_cost', $cost, 300 ); // 5 min cache
		return $cost;
	}
	...
	private static function update_daily_cache() {
		delete_transient( 'n8npress_today_token_cost' );
	}
